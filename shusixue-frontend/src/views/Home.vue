        ...
        <div class="recent-homeworks">
          <el-card v-for="homework in recentHomeworks" :key="homework.id" class="homework-card">
            <div class="homework-info">
              ...
              <p class="homework-desc">{{ homework.description || '无描述' }}</p>
...
const welcomeMessage = computed(() => {
  if (isTeacher.value) {
  return '您可以在这里管理作业、查看学情分析和发布新作业'
  } else {
  return '您可以在这里查看作业、学习知识点和提交作业'
  }
})
